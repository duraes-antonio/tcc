# Obtido de: https://github.com/heaversm/deeplab-training/blob/master/models/research/deeplab/datasets/build_pqr_data.py
...
tf.app.flags.DEFINE_string(
	'image_folder',
	f'{path_dataset}/JPEGImages',
	'Folder containing images.'
)

tf.app.flags.DEFINE_string(
	'semantic_segmentation_folder',
	f'{path_dataset}/SegmentationClassRaw',
	'Folder containing semantic segmentation annotations.'
)

tf.app.flags.DEFINE_string(
	'list_folder',
	f'{path_dataset}/ImageSets',
	'Folder containing lists for training and validation'
)

tf.app.flags.DEFINE_string(
	'output_dir',
	f'{path_dataset}/tfrecord',
