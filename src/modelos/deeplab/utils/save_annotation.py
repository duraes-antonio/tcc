...
def save_annotation(
		label, save_dir, filename, add_colormap=True,
		normalize_to_unit_values=False, scale_values=False,
...
def build_annotation(
	...
	return img.fromarray(colored_label.astype(dtype=np.uint8))
