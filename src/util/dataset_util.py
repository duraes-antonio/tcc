...
def preparar_img(
	...
	return iu.converter_img_para_bytes(img_editada, formato_saida)


async def baixar_imagens(
		urls_download: List[str], dir_saida='../../dataset', formatos=('jpeg', 'jpg', 'png'),
		formato_saida='jpeg', label_cor=None,
...
def imgs_nao_existem(
	...
	return list(imgs_existentes.intersection(imgs_treino_existentes))
